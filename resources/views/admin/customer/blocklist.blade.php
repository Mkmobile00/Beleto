@extends('admin.app')
@section('title', 'All Blocked Customer')
@section('main')
                        ...
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <a href="{{route('customer.blockedlist')}}">
                                    <span class="info-box-number">{{ @$blockedUser }}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Blocked Customer List
...
@push('scripts')
    <script>
        ...
        function searchCustomer(data) {
            ...
            $.ajax({
                url: "{{ route('search.customerBlocked') }}",
                type: "get",
                data: {
