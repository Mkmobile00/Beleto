@extends('admin.app')
@section('title', 'All Verified Customer')
@section('main')
                        ...
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <a href="{{route('customer.verifiedlist')}}">
                                    <span class="info-box-number">{{@$verifiedUser}}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Verified Customer List
...
@push('scripts')
    <script>
        ...
        function searchCustomer(data) {
            ...
            $.ajax({
                url: "{{ route('search.customerVerified') }}",
                type: "get",
                data: {
