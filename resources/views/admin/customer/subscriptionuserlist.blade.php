@extends('admin.app')
@section('title', 'All Subscription Customer')
@section('main')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Subscription Customer List</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="info-box mb-3">
                            ...
                            <div class="info-box-content">
                                ...
                                <a href="{{route('customer.subscriptionuserlist')}}">
                                    <span class="info-box-number">{{@$totalCustomerSubscription}}
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Subscription Customer List
...
@push('scripts')
    <script>
        ...
        function searchCustomer(data) {
            ...
            $.ajax({
                url: "{{ route('search.customerSubscription') }}",
                type: "get",
                data: {
