...
const isSameDay = (date1, date2) => {
  ...
  progressForm.addEventListener('submit', e => {
    ...
    let transcodePath = getValueByNameOrId('transcodePath');
    let transodeStatus = getValueByNameOrId('transodeStatus');
    ...
    $.ajax({
      ...
      success:function(response){
        ...
        $('#finalSubmittion').text('Form Submitted');
