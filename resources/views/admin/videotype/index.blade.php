@extends('admin.app')
@section('title', 'Videos Type Management')
@section('main')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Video Type</h3>
                            </div>
                            <div class="card-body">
                                {{Form::open(['url'=>route('video-type.store'),'class'=>'form form-horizontal'])}}
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group mt-2">
                                        ...
                                        <br>
                                        <input type="checkbox" name="primary_menu" id="primary_menu" value="1">
                                        @error('primary_menu')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 form-group mt-2">
                                        ...
                                        <br>
                                        <input type="checkbox" name="footer_menu" id="footer_menu" value="1">
                                        @error('footer_menu')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <div class="col-6">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Video Type List</h3>
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @foreach($videoTypes as $key=>$data)
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td>{{ $data->title }}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="{{route('video-type.edit',$data->id)}}">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="javascript:;" class="btn btn-sm  icon btn-rounded btn-danger btn-style delete-visitor" data-id="{{ $data->id}}">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                    {{ Form::open(['url'=>route('video-type.destroy',$data->id),'class'=>'delete-form'])}}
                                                        @method('delete')
                                                    {{ Form::close()}}
