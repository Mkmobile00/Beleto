                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('tvseries.index') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            ...
                            <a href="{{ route('webseries.index') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- ./col -->
                        ...
                        <div class="card card-danger">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-valign-middle table-sm captionShow">
                                    ...
                                    <div>
                                        <tbody>
                                            @foreach ($topFiveVideos as $key => $data)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    <td>
                                                        <a href="{{ @$data['path'] }}"
                                                    ...
                                                    <td>
                                                        <img src=" {{ @$data['poster'] }}" height="100px"
                                                            alt="">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="badge badge-info"> {{ $data['views'] }}</span>
                                                    </td>
...
@push('scripts')
    <script>
        ...
        let statusLabelsDelivered = @json(@$paymentOptions);
        let shipmentStatusDataDelivered = {{ json_encode(@$paymentHistory) }};
        ...
        let customerDevice = @json(@$loginDevice);
        let customerDeviceData = {{ json_encode(@$loginDeviceData) }};
