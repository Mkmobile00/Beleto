@extends('admin.app')
@section('title', 'Movie Theater Timing Edit')
@push('styles')
...
<div class="wrapper">
    <div class="content-wrapper">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">{{ @$model->title }} /</span> Edit Time Slot
        </h4>
        <!-- FormValidation -->
        <form id="form" class="row g-3" method="POST" action="{{ route('editTheaterTime',@$model->id) }}"
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="wednesday" class="form-check-input day"
                                                        ...
                                                        {{ old('wednesday') == 'wednesday' || isset($slots['wednesday']) ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="wednesday">Wednesday</label>
                                                </div>
                                            </td>
                                            <td>
                                                @if (isset($slots['wednesday']))
                                                    @foreach ($slots['wednesday'] as $wednesday_slot)
