        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <a href="{{route('stremming.create')}}" class="btn btn-sm btn-success ml-auto">Add Stremming</a>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Stremming List</h3>
                                    ...
                                    <tbody id="tablecontents">
                                        @foreach($tvseries as $key=>$data)
                                            <tr class="row1" data-id="{{ $data->id }}">
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="{{route('stremming.edit',$data->id)}}">
                                                    ...
                                                    {{ Form::open(['url'=>route('stremming.destroy',$data->id),'class'=>'delete-form'])}}
                                                        @method('delete')
                                                    {{ Form::close() }}
                                                </td>
                                            </tr>
...
@push('scripts')
    <script>
        ...
        e.preventDefault();
        let clicked=confirm('Are You Sure Want To Delete Stremming');
        ...
        $(function() {
            ...
            function sendOrderToServer() {
                ...
                $.ajax({
                    type: "post",
                    dataType: "json",
                    url: "{{ route('stremming.updatePosition') }}",
                    data: {
                        order: order,
                    },
