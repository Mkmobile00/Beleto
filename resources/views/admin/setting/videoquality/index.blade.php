@extends('admin.app')
@section('title', 'Videos quality Management')
@section('main')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Videos quality Management</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                {{Form::open(['url'=>route('video-quality.store'),'class'=>'form form-horizontal'])}}
                                <div class="row">
                                ...
                                {{Form::close()}}
                                <h4 class="text-center">Default Video quality</h4>
                                <hr>
                                ...
                                <div class="col-md-12 form-group mt-2">
                                    ...
                                    <select name="status_default" id="status_default" class="form-control" required>
                                        @foreach ($videoQualitys as $quality)
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        @foreach($videoQualitys as $key=>$data)
                                            <tr>
                                                <td>{{$key+1}}</td>
                                                <td>{{ $data->quality }}</td>
