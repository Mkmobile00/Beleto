                        ...
                        <form id="progress-form" class="p-4 progress-form" action="javascript:;" lang="en"
                            ...
                            <div class="d-flex align-items-start mb-3 sm:mb-5 progress-form__tabs" role="tablist">
                                <button id="progress-form__tab-1" class="flex-1 px-0 pt-2 progress-form__tabs-item"
                                    ...
                                    aria-selected="true">
                                    <span class="d-block step" aria-hidden="true">WebSeries Details
                                </button>
                                ...
                                <button id="progress-form__tab-3" class="flex-1 px-0 pt-3 progress-form__tabs-item"
                                    ...
                                    <span class="d-block step" aria-hidden="true">WebSeries Elements
                                </button>
                              ...
                              <section id="progress-form__panel-1" role="tabpanel" aria-labelledby="progress-form__tab-1"
                                  ...
                                  <div class="sm:d-grid sm:grid-col-12 sm:mt-3">
                                      <div class="mt-3 sm:mt-0 form__field">
                                          ...
                                          <input id="title" type="text" name="title" value="{{@$tvseries->title}}" autocomplete="given-name"
                                              required>
                                      </div>
                                  </div>
                                  <div class="sm:d-grid sm:grid-col-12 sm:mt-3">
                                    <div class="mt-3 sm:mt-0 form__field">
                                        <label for="summary">Summary<span data-required="true"
                                  ...
                                  <div class="mt-3 form__field">
                                      ...
                                      <input id="youtube_trailer" type="url" value="{{@$tvseries->trailer_url}}" name="youtube_trailer"
                                  ...
                                  <div class="mt-3 form__field">
                                      ...
                                      <select name="video_quality[]" id="video_quality" class="select2" multiple
                                          ...
                                          @foreach ($videoQuality as $quality)
                                              <option value="{{ $quality->id }}" {{in_array($quality->id,$tvseries->videoQuality->pluck('id')->toArray()) ? 'selected':''}}>{{ $quality->quality }}</option>
                                          @endforeach
                                      </select>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                      ...
                                      <select name="actor[]" id="actor" class="select2" multiple
                                          ...
                                          @foreach ($actors as $actor)
                                              <option value="{{ $actor->id }}" {{in_array($actor->id,$tvseries->actor->pluck('id')->toArray()) ? 'selected':''}}>{{ $actor->name }}</option>
                                          @endforeach
                                      </select>
                                  ...
                                  <div class="mt-3 form__field">
                                      ...
                                      <select name="director[]" id="director" class="select2" multiple
                                          ...
                                          @foreach ($directors as $director)
                                              <option value="{{ $director->id }}" {{in_array($director->id,$tvseries->director->pluck('id')->toArray()) ? 'selected':''}}>{{ $director->name }}</option>
                                          @endforeach
                                      </select>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="writer[]" id="writer" class="select2" multiple
                                          ...
                                          @foreach ($writers as $writer)
                                              <option value="{{ $writer->id }}" {{in_array($writer->id,$tvseries->writer->pluck('id')->toArray()) ? 'selected':''}}>{{ $writer->name }}</option>
                                          @endforeach
                                    </select>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="producer[]" id="producer" class="select2" multiple
                                        ...
                                        @foreach ($producers as $producer)
                                            <option value="{{ $producer->id }}" {{in_array($producer->id,$tvseries->producer->pluck('id')->toArray()) ? 'selected':''}}>{{ $producer->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mt-3 form__field">
                                    ...
                                    <select name="cinematographer[]" id="cinematographer" class="select2" multiple
                                        ...
                                        @foreach ($cinematographers as $cinematographer)
                                            <option value="{{ $cinematographer->id }}" {{in_array($cinematographer->id,$tvseries->cinematographer->pluck('id')->toArray()) ? 'selected':''}}>{{ $cinematographer->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mt-3 form__field">
                                    ...
                                    <select name="editor[]" id="editor" class="select2" multiple
                                        ...
                                        @foreach ($editors as $editor)
                                            <option value="{{ $editor->id }}" {{in_array($editor->id,$tvseries->editor->pluck('id')->toArray()) ? 'selected':''}}>{{ $editor->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mt-3 form__field">
                                    ...
                                    <select name="music[]" id="music" class="select2" multiple
                                        ...
                                        @foreach ($musics as $music)
                                            <option value="{{ $music->id }}" {{in_array($music->id,$tvseries->music->pluck('id')->toArray()) ? 'selected':''}}>{{ $music->name }}</option>
                                        @endforeach
                                    </select>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="genre[]" id="genre" class="select2" multiple
                                          ...
                                          @foreach ($genres as $genre)
                                              <option value="{{ $genre->id }}" {{in_array($genre->id,$tvseries->genre->pluck('id')->toArray()) ? 'selected':''}}>{{ $genre->title }}</option>
                                          @endforeach
                                    </select>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <input id="rating" type="number" max="5" value="{{@$tvseries->rating}}" name="rating" required>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <input id="run_time" type="text" value="{{@$tvseries->run_time}}" name="run_time">
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <input id="release_date" type="date" value="{{@$tvseries->release_date}}" name="release_date" required>
                                  </div>
                                  <div
                            ...
                            <!-- Step 3 -->
                              <section id="progress-form__panel-3" role="tabpanel" aria-labelledby="progress-form__tab-3"
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="country[]" id="country" class="select2" multiple required>
                                          @foreach ($countries as $country)
                                              <option value="{{ $country->id }}" {{in_array($country->id,$tvseries->country->pluck('id')->toArray()) ? 'selected':''}}>{{ $country->title }}</option>
                                          @endforeach
                                    </select>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="language[]" id="language" class="select2" multiple required>
                                          @foreach ($languages as $language)
                                              <option value="{{ $language->id }}" {{in_array($language->id,$tvseries->language->pluck('id')->toArray()) ? 'selected':''}}>{{ $language->title }}</option>
                                          @endforeach
                                    </select>
                                  </div>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="video_type[]" id="video_type" class="select2" multiple required>
                                          @foreach ($videoTypes as $videoType)
                                              <option value="{{ $videoType->id }}" {{in_array($videoType->id,$tvseries->videoType->pluck('id')->toArray()) ? 'selected':''}}>{{ $videoType->title }}</option>
                                          @endforeach
                                    </select>
                                  </div>
                                  <div class="mt-3 form__field">
                                    <label class="form__choice-wrapper">
                                      <input type="checkbox" name="publication" id="publication" value="1" {{@$tvseries->publication=='1' ? 'checked':''}}>
                                  ...
                                  <div class="mt-3 form__field">
                                    <label class="form__choice-wrapper">
                                      <input type="checkbox" name="download" id="download" value="1" {{@$tvseries->download=='1' ? 'checked':''}}>
                                  ...
                                  <div class="mt-3 form__field">
                                    ...
                                    <select name="free_paid" id="free_paid" class="select2" required>
                                          ...
                                          <option value="paid" {{@$tvseries->freePaid=='paid' ? 'selected' : ''}}>Paid</option>
                                    </select>
                                  </div>
                                  <div
                                      class="d-flex flex-column-reverse sm:flex-row align-items-center justify-center sm:justify-end mt-4 sm:mt-5">
                              ...
                              <section id="progress-form__panel-4" role="tabpanel" aria-labelledby="progress-form__tab-4"
                                ...
                                <div class="mt-3 form__field" id="imageFile">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail1" class="form-control" type="text" name="thumbnail" value="{{old('thumbnail', @$tvseries->thumbnail)}}">
                                      </div>
                                    ...
                                    @isset($tvseries)
                                      <div class="col-md-4">
                                            <img src="{{asset(@$tvseries->thumbnail)}}" alt="Img" class="img img-fluid img-thumbnail" style="width:100px; height:auto;">
                                      </div>
                                    @endisset
                                </div>
                                ...
                                <div class="mt-3 form__field" id="imageFile1">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <input id="thumbnail11" class="form-control" type="text" name="poster" value="{{old('poster', @$tvseries->poster)}}">
                                    </div>
                                  <img id="holder" style="margin-top:15px;max-height:100px;">
                                  ...
                                  @isset($tvseries)
                                    <div class="col-md-4">
                                          <img src="{{asset(@$tvseries->poster)}}" alt="Img" class="img img-fluid img-thumbnail" style="width:100px; height:auto;">
                                    </div>
                                  @endisset
                                </div>
                                ...
                                <div class="mt-3 form__field">
                                  ...
                                  <input id="meta_title" type="text" value="{{@$tvseries->meta_title}}" name="meta_title" >
                                </div>
                                ...
                                <div class="mt-3 form__field">
                                  ...
                                  <input id="meta_keyword" type="text" value="{{@$tvseries->meta_keyword}}" name="meta_keyword" >
                                </div>
                                ...
                                <div class="mt-3 form__field">
                                  ...
                                  <input id="meta_description" type="text" value="{{@$tvseries->meta_description}}" name="meta_description">
                                </div>
...
@push('scripts')
    ...
    @include('admin.webseriescss.moviejsupdate')
@endpush
