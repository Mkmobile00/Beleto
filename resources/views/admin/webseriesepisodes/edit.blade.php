                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <input type="text" name="transcodeStatus" value="{{@$tvseriespart->transcodeStatus=='true' ? 'true':'false'}}" hidden id="transcodeStatus">
                                    <div class="col-md-6 form-group mt-2">
...
<script>
    $(document).on('click','#submitForm',function(){
        ...
        let transcodeStatus=formData['transcodeStatus'].value;
