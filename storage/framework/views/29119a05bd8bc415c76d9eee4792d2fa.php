<?php $__env->startSection('title', 'Movie Theater Timing'); ?>
    ...
    <div class="wrapper">
        <div class="content-wrapper">
            <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light"><?php echo e(@$theater->title); ?> /</span> Set Time Slot
            </h4>
            <!-- FormValidation -->
            <form id="form" class="row g-3" method="POST" action="<?php echo e(route('addTheaterTime',@$theater->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body row">
                            <div class="col-md-6 mb-3" hidden>
                                ...
                                <input type="number" id="interval" class="form-control" name="interval"
                                    value="<?php echo e(old('interval', 60)); ?>" pattern="^\d+$
                            " />
                            </div>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="sunday" class="form-check-input day"
                                                            ...
                                                            <?php echo e(old('sunday') == 'sunday' ? 'checked' : 'checked'); ?>>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="monday" class="form-check-input day"
                                                            ...
                                                            <?php echo e(old('monday') == 'monday' ? 'checked' : 'checked'); ?>>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="tuesday" class="form-check-input day"
                                                            ...
                                                            <?php echo e(old('tuesday') == 'tuesday' ? 'checked' : 'checked'); ?>>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="wednesday"
                                                            ...
                                                            <?php echo e(old('wednesday') == 'wednesday' ? 'checked' : 'checked'); ?>>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="thursday"
                                                            ...
                                                            <?php echo e(old('thursday') == 'thursday' ? 'checked' : 'checked'); ?>>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="friday"
                                                            ...
                                                            <?php echo e(old('friday') == 'friday' ? 'checked' : 'checked'); ?>>
                                                ...
                                                <td>
                                                    <div class="form-check form-switch mb-2">
                                                        <input type="checkbox" name="saturday"
                                                            ...
                                                            <?php echo e(old('saturday') == 'saturday' ? 'checked' : 'checked'); ?>>
