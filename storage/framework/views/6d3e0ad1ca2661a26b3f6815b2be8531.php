<script src="<?php echo e(asset('frontend/assets/js/bootstrap.bundle.min.js')); ?>" crossorigin="anonymous"></script>
<script src="<?php echo e(asset('frontend/assets/js/custom.js')); ?>" crossorigin="anonymous"></script>
<script src="https://code.jquery.com/jquery-2.2.0.min.js" type="text/javascript"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
<script src="<?php echo e(asset('frontend/assets/slider/slick/slick.js')); ?>" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
  $(document).on('click','.removeWishlist',function(){
    ...
    $.ajax({
        url:"<?php echo e(route('removeFromWishList')); ?>",
        type:"post",
        data:{
          id:wishlistId
        },
...
<?php /**PATH C:\xampp\htdocs\nextcinemas\nextcinemas\resources\views/frontend/includes/footer.blade.php ENDPATH**/ ?>