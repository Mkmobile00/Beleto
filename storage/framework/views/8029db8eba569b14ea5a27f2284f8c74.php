<?php $__env->startSection('title', 'Movie Theater Timing Edit'); ?>
...
<div class="wrapper">
    <div class="content-wrapper">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light"><?php echo e(@$model->title); ?> /</span> Edit Time Slot
        </h4>
        <!-- FormValidation -->
        <form id="form" class="row g-3" method="POST" action="<?php echo e(route('editTheaterTime',@$model->id)); ?>"
                                ...
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0" id="sortable">
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="sunday" class="form-check-input day"
                                                        ...
                                                        <?php echo e(old('sunday') == 'sunday' || isset($slots['sunday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="sunday">Sunday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['sunday'])): ?>
                                                    <?php $__currentLoopData = $slots['sunday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sunday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-sunday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[sunday][]"
                                                                    class="form-control timepicker day-sunday"
                                                                    value="<?php echo e($sunday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[sunday][]"
                                                                    class="form-control timepicker day-sunday"
                                                                    value="<?php echo e($sunday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-sunday"
                                                                        href="#!" data-day="sunday"
                                                                        data-endtime="<?php echo e($slots['sunday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-sunday"
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="monday" class="form-check-input day"
                                                        ...
                                                        <?php echo e(old('monday') == 'monday' || isset($slots['monday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="monday">Monday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['monday'])): ?>
                                                    <?php $__currentLoopData = $slots['monday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-monday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[monday][]"
                                                                    class="form-control timepicker day-monday"
                                                                    value="<?php echo e($monday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[monday][]"
                                                                    class="form-control timepicker day-monday"
                                                                    value="<?php echo e($monday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-monday"
                                                                        href="#!" data-day="monday"
                                                                        data-endtime="<?php echo e($slots['monday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-monday"
                                                                        href="#!"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                            ...
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="tuesday" class="form-check-input day"
                                                        ...
                                                        <?php echo e(old('tuesday') == 'tuesday' || isset($slots['tuesday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="tuesday">Tuesday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['tuesday'])): ?>
                                                    <?php $__currentLoopData = $slots['tuesday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tuesday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-tuesday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[tuesday][]"
                                                                    class="form-control timepicker day-tuesday"
                                                                    value="<?php echo e($tuesday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[tuesday][]"
                                                                    class="form-control timepicker day-tuesday"
                                                                    value="<?php echo e($tuesday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-tuesday"
                                                                        href="#!" data-day="tuesday"
                                                                        data-endtime="<?php echo e($slots['tuesday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-tuesday"
                                                                        href="#!"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <div class="col-md-12 row day-tuesday">
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="start_time[tuesday][]"
                                                                class="form-control timepicker day-tuesday" value="10:00" />
                                                        </div>
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="end_time[tuesday][]"
                                                                class="form-control timepicker day-tuesday" value="11:00" />
                                                        </div>
                                                        <div class="col-md-3 mb-1">
                                                            <a class="btn btn-icon btn-primary add-time day-tuesday"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="wednesday" class="form-check-input day"
                                                        id="wednesday" value="wednesday"
                                                        <?php echo e(old('wednesday') == 'wednesday' || isset($slots['wednesday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="wednesday">Wednesday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['wednesday'])): ?>
                                                    <?php $__currentLoopData = $slots['wednesday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wednesday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-wednesday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[wednesday][]"
                                                                    ...
                                                                    value="<?php echo e($wednesday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[wednesday][]"
                                                                    class="form-control timepicker day-wednesday"
                                                                    value="<?php echo e($wednesday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-wednesday"
                                                                        href="#!" data-day="wednesday"
                                                                        data-endtime="<?php echo e($slots['wednesday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-wednesday"
                                                                        href="#!"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <div class="col-md-12 row day-wednesday">
                                                        ...
                                                        <div class="col-md-3 mb-1">
                                                            <a class="btn btn-icon btn-primary add-time day-wednesday"
                                                                href="#!" data-day="wednesday" data-endtime="11:00"><i
                                                                    class="fas fa-plus"></i></a>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="thursday" class="form-check-input day"
                                                        id="thursday" value="thursday"
                                                        <?php echo e(old('thursday') == 'thursday' || isset($slots['thursday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="thursday">Thursday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['thursday'])): ?>
                                                    <?php $__currentLoopData = $slots['thursday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thursday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-thursday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[thursday][]"
                                                                    class="form-control timepicker day-thursday"
                                                                    value="<?php echo e($thursday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[thursday][]"
                                                                    class="form-control timepicker day-thursday"
                                                                    value="<?php echo e($thursday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-thursday"
                                                                        href="#!" data-day="thursday"
                                                                        data-endtime="<?php echo e($slots['thursday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-thursday"
                                                                        href="#!"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <div class="col-md-12 row day-thursday">
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="start_time[thursday][]"
                                                                class="form-control timepicker day-thursday" value="10:00" />
                                                        </div>
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="end_time[thursday][]"
                                                                class="form-control timepicker day-thursday" value="11:00" />
                                                        </div>
                                                        <div class="col-md-3 mb-1">
                                                            <a class="btn btn-icon btn-primary add-time day-thursday"
                                                                href="#!" data-day="thursday" data-endtime="11:00"><i
                                                                    class="fas fa-plus"></i></a>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="friday" class="form-check-input day"
                                                        id="friday" value="friday"
                                                        <?php echo e(old('friday') == 'friday' || isset($slots['friday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="friday">Friday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['friday'])): ?>
                                                    <?php $__currentLoopData = $slots['friday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $friday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-friday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[friday][]"
                                                                    class="form-control timepicker day-friday"
                                                                    value="<?php echo e($friday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[friday][]"
                                                                    class="form-control timepicker day-friday"
                                                                    value="<?php echo e($friday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-friday"
                                                                        href="#!" data-day="friday"
                                                                        data-endtime="<?php echo e($slots['friday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-friday"
                                                                        href="#!"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <div class="col-md-12 row day-friday">
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="start_time[friday][]"
                                                                class="form-control timepicker day-friday" value="10:00" />
                                                        </div>
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="end_time[friday][]"
                                                                class="form-control timepicker day-friday" value="11:00" />
                                                        </div>
                                                        <div class="col-md-3 mb-1">
                                                            <a class="btn btn-icon btn-primary add-time day-friday"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-switch mb-2">
                                                    <input type="checkbox" name="saturday" class="form-check-input day"
                                                        id="saturday" value="saturday"
                                                        <?php echo e(old('saturday') == 'saturday' || isset($slots['saturday']) ? 'checked' : ''); ?>>
                                                    <label class="form-check-label" for="saturday">Saturday</label>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if(isset($slots['saturday'])): ?>
                                                    <?php $__currentLoopData = $slots['saturday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $saturday_slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="col-md-12 row day-saturday">
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="start_time[saturday][]"
                                                                    class="form-control timepicker day-saturday"
                                                                    value="<?php echo e($saturday_slot->start_time); ?>" />
                                                            </div>
                                                            <div class="col-md-4 mb-1">
                                                                <input type="text" name="end_time[saturday][]"
                                                                    class="form-control timepicker day-saturday"
                                                                    value="<?php echo e($saturday_slot->end_time); ?>" />
                                                            </div>
                                                            <?php if($loop->first): ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-primary add-time day-saturday"
                                                                        href="#!" data-day="saturday"
                                                                        data-endtime="<?php echo e($slots['saturday']->last()->end_time); ?>"><i
                                                                            class="fas fa-plus"></i></a>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="col-md-3 mb-1">
                                                                    <a class="btn btn-icon btn-danger delete-time day-saturday"
                                                                        href="#!"><i class="fas fa-trash"></i></a>
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                ...
                                                <?php else: ?>
                                                    <div class="col-md-12 row day-saturday">
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="start_time[saturday][]"
                                                                class="form-control timepicker day-saturday" value="10:00" />
                                                        </div>
                                                        <div class="col-md-4 mb-1">
                                                            <input type="text" name="end_time[saturday][]"
                                                                class="form-control timepicker day-saturday" value="11:00" />
                                                        </div>
                                                        <div class="col-md-3 mb-1">
                                                            <a class="btn btn-icon btn-primary add-time day-saturday"
                                                                href="#!" data-day="saturday" data-endtime="11:00"><i
                                                                    class="fas fa-plus"></i></a>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            addTimeButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    ...
                    const html = `
                <div class="col-md-12 row day-${button.dataset.day}">
                    <div class="col-md-4 mb-1">
        ...
        $(document).on('change', 'input[name^="start_time"]', function() {
            ...
            if (date1 > date2) {
                ...
                showToast('warning', `${startTime} is after ${endTime}`);
        ...
        $(document).on('change', 'input[name^="end_time"]', function() {
            ...
            if (date1 < date2) {
                $(this).addClass('invalid');
                showToast('warning', `${endTime} is before ${startTime}`);
            } else {
                $(this).removeClass('invalid');
            }
