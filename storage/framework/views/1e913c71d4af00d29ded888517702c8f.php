...
<?php $__env->startSection('title', 'All Visitors'); ?>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($data->name); ?></td>
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="<?php echo e(route('user.edit',$data->id)); ?>">
                                                    ...
                                                    <?php echo e(Form::open(['url'=>route('user.destroy',$data->id),'class'=>'delete-form'])); ?>
