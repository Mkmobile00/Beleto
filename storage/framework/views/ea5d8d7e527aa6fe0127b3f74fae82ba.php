        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <a href="<?php echo e(route('city.create')); ?>" class="btn btn-sm btn-success ml-auto">Create City</a>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="<?php echo e(route('city.edit',$data->id)); ?>">
                                                    ...
                                                    <?php echo e(Form::open(['url'=>route('city.destroy',$data->id),'class'=>'delete-form'])); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        e.preventDefault();
        let clicked=confirm('Are You Sure Want To Delete City');
