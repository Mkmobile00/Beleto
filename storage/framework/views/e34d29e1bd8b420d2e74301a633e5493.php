...
<?php $__env->startSection('title', 'Push Notification List'); ?>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <a href="<?php echo e(route('pushnotification.create')); ?>" class="btn btn-sm btn-success ml-auto">Create Push Notitfication</a>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Notitfication List
                                </h3>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-info"><?php echo e($data->status->name); ?></span>
                                                    
                                                </td>
                                                
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="<?php echo e(route('pushnotification.edit',$data->id)); ?>">
                                                    ...
                                                    <?php echo e(Form::open(['url'=>route('pushnotification.destroy',$data->id),'class'=>'delete-form'])); ?>
