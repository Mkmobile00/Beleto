        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <a href="<?php echo e(route('post.create')); ?>" class="btn btn-sm btn-success ml-auto">Add Post</a>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php $__currentLoopData = $data->postCategory->pluck('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="badge badge-success"><?php echo e($cat); ?></span>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </td>
                                                <td><?php echo e($data->status->name); ?></td>
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="<?php echo e(route('post.edit',$data->id)); ?>">
                                                    ...
                                                    <?php echo e(Form::open(['url'=>route('post.destroy',$data->id),'class'=>'delete-form'])); ?>
