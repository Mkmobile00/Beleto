...
return new class extends Migration
{
    ...
    {
        Schema::create('stremmings', function (Blueprint $table) {
            $table->id();
            $table->string('title')->unique()->nullable();
            $table->string('slug')->unique()->nullable();
            $table->text('unique_code')->unique()->nullable();
            ...
            $table->longText('movie_path')->after('slug')->nullable();
    ...
    {
        Schema::dropIfExists('stremmings');
    }
};
