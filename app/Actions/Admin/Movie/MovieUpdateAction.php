...
class MovieUpdateAction
{
    ...
    {
        if ($this->request['transcodeStatus'] && $this->request['transcodeStatus'] == 'false') {
            $this->request['transcodeStatus'] = 'false';
            $this->request['transcode'] = null;
        } else {
            $this->request['transcodeStatus'] = 'true';
            $this->request['transcode'] = $this->movie->transcode;
        }
        // dd($this->request);
        ...
        $data = [
            ...
            'transcodeStatus' => $this->request['transcodeStatus'],
            'transcode' => $this->request['transcode'],
        ];
