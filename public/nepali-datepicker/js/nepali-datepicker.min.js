var NepaliFunctions = function() {
    ...
    function e() {
        ...
        function n(e) { var t = 0; return e.forEach(function(e) { t += e }), t }
        ...
        function i(e, t) { var n = new Date(r(e, "MM/DD/YYYY")); return n.setDate(n.getDate() + t), { year: n.getFullYear(), month: n.getMonth() + 1, day: n.getDate() } }

        function u(e, t) { for (e.day += t; e.day > c[e.year][e.month - 1];) e.day -= c[e.year][e.month - 1], e.month += 1, e.month > 12 && (e.month = 1, e.year += 1); return { year: e.year, month: e.month, day: e.day } }

        function d(e) { var t = o(m, e); return i(h, t) }

        function l(e) { var t = a(h, e); return u(m, t) }

        function s(e, t) { return c[e][t - 1] }
        var c = [],
        ...
        return { minDate: e, maxDate: t, countAdDays: a, countBsDays: o, addBsDays: u, addAdDays: i, bs2ad: d, ad2bs: l, getDaysInMonth: s }
    }
    ...
    function t(e) {
        function t(e) {
            ...
            var a = r.filter(function(e) { return 1 == e.year })[0];
            if (a) {
                t.year = a.value, n[a.index] = "YYYY";
                var o = r.filter(function(e) { return 1 == e.day }),
                    i = r.filter(function(e) { return 1 == e.month });
                1 == i.length ? (t.month = i[0].value, n[i[0].index] = "MM", 1 == o.length ? (t.day = o[0].value, n[o[0].index] = "DD") : (o = o.find(function(e) { return !e.month }), t.day = o.value, n[o.index] = "DD")) : 2 == i.length && 0 == o.length ? (t.month = i[0].value, t.day = i[1].value, n[i[0].index] = "MM", n[i[1].index] = "DD") : 2 == i.length && 2 == o.length && (t.month = o[0].value, t.day = o[1].value, n[o[0].index] = "MM", n[o[1].index] = "DD")
            }
    ...
    function r(e, t) {
        function n(e) { return e = Number(e), e < 10 ? "0" + e : e }
        var r = "";
    ...
    function o(t) { return (new e).bs2ad(t) }
    ...
    function d() { var e = u(); return Number(e.year) }

    function l() { var e = u(); return Number(e.month) }

    function s() { var e = u(); return Number(e.day) }

    function c() { return a(u()) }

    function m() { var e = c(); return Number(e.year) }

    function h() { var e = c(); return Number(e.month) }

    function p() { var e = c(); return Number(e.day) }

    function f() { return ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] }

    function y(e) { return e = Number(e), isNaN(e) || e < 0 || e > 11 ? null : f()[e] }

    function v() { return ["Baisakh", "Jestha", "Ashar", "Shrawan", "Bhadra", "Ashoj", "Kartik", "Mangsir", "Poush", "Magh", "Falgun", "Chaitra"] }

    function g(e) { return e = Number(e), isNaN(e) || e < 0 || e > 11 ? null : v()[e] }

    function b() { return ["बैशाख", "जेठ", "अषाढ", "श्रावण", "भाद्र", "आश्विन", "कार्तिक", "मङ्सिर", "पौष", "माघ", "फाल्गुन", "चैत्र"] }

    function D(e) { return e = Number(e), isNaN(e) || e < 0 || e > 11 ? null : b()[e] }
    ...
    function M() { return ["आ", "सो", "मं", "बु", "बि", "शु", "श"] }

    function Y() { return ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"] }

    function B() { return ["S", "M", "T", "W", "T", "F", "S"] }

    function C(e) { return e = Number(e), isNaN(e) || e < 0 || e > 6 ? null : Y()[Number(e)] }
    ...
    function F(e) { return e.day + " " + NepaliFunctions.GetAdMonth(e.month - 1) + " " + e.year }

    function T(e) { var t = NepaliFunctions.BS2AD(e); return t = new Date(t.year, t.month - 1, t.day), C(t.getDay()) }

    function S(e) { var t = NepaliFunctions.BS2AD(e); return t = new Date(t.year, t.month - 1, t.day), A(t.getDay()) }

    function I(e) { return e = new Date(e.year, e.month - 1, e.day), C(e.getDay()) }

    function x(t, n) {
        var r = new e,
            a = r.bs2ad(t);
        return a = new Date(a.year, a.month - 1, a.day), a.setDate(a.getDate() + n), a = { year: a.getFullYear(), month: a.getMonth() + 1, day: a.getDate() }, r.ad2bs(a)
    }

    function G(t, n) { return (new e).countAdDays(t, n) }

    function w(t, n) { if (!i(t) || !i(n)) return !1; var r = new e; return t = r.bs2ad(t), n = r.bs2ad(n), r.countAdDays(t, n) }

    function O(e, t) { return new Date(e, t, 0).getDate() }
    ...
    function P(e) { return e < 10 ? "0" + Number(e) : e }

    function U(e, t) {
        function n(e) {
            var t = { 0: "", 1: "One", 2: "Two", 3: "Three", 4: "Four", 5: "Five", 6: "Six", 7: "Seven", 8: "Eight", 9: "Nine", 10: "Ten", 11: "Eleven", 12: "Twelve", 13: "Thirteen", 14: "Fourteen", 15: "Fifteen", 16: "Sixteen", 17: "Seventeen", 18: "Eighteen", 19: "Nineteen", 20: "Twenty", 30: "Thirty", 40: "Forty", 50: "Fifty", 60: "Sixty", 70: "Seventy", 80: "Eighty", 90: "Ninety" };
            e = Number(e);
            var n = e.toString();
    ...
    return { ParseDate: t, ValidateBsDate: i, CompareBsDates: R, ConvertToDateObject: n, ConvertDateFormat: r, AD2BS: a, BS2AD: o, GetCurrentAdDate: u, GetCurrentAdYear: d, GetCurrentAdMonth: l, GetCurrentAdDay: s, GetCurrentBsDate: c, GetCurrentBsYear: m, GetCurrentBsMonth: h, GetCurrentBsDay: p, GetAdMonths: f, GetAdMonth: y, GetBsMonths: v, GetBsMonth: g, GetBsDaysUnicode: N, GetBsDaysUnicodeShort: M, GetBsDayUnicode: A, GetAdDays: Y, GetAdDaysShort: B, GetAdDay: C, GetBsMonthsInUnicode: b, GetBsMonthInUnicode: D, GetDaysInAdMonth: O, GetDaysInBsMonth: L, AdDatesDiff: G, BsDatesDiff: w, BsAddDays: x, GetBsFullDate: E, GetAdFullDate: F, GetAdFullDay: I, GetBsFullDay: T, GetBsFullDayInUnicode: S, ConvertToUnicode: k, ConvertToNumber: j, Get2DigitNo: P, NumberToWords: U, NumberToWordsUnicode: H }
}();
! function() {
    function e(e, t) {
        var n = e,
    ...
    function i(n, r, a) {
        ...
        var F = !0;
        d.disableBefore && NepaliFunctions.CompareBsDates(d.disableBefore, { year: M, month: Y, day: NepaliFunctions.GetDaysInBsMonth(M, Y) }) && (F = !1);
        var T = document.createElement("SPAN");
        T.setAttribute("class", "ndc-chevron ndc-left");
        var S = document.createElement("A");
        S.setAttribute("id", "prev"), S.setAttribute("title", "Previous Month"), S.setAttribute("class", F ? "ndp-prev" : "ndp-prev ndp-disabled"), S.setAttribute("href", "javascript:void(0)"), S.appendChild(T), F && S.addEventListener("click", function() { i(M, Y, a) });
        var I = !0;
        ...
        G.setAttribute("id", "next"), G.setAttribute("title", "Next Month"), G.setAttribute("class", I ? "ndp-next" : "ndp-next ndp-disabled"), G.setAttribute("href", "javascript:void(0)"), G.appendChild(x), I && G.addEventListener("click", function() { i(N, A, a) }), B.appendChild(S), B.appendChild(G), o.getElementsByTagName("table")[0].insertAdjacentElement("beforeend", u(n, r, a))
    }
        ...
        for (var T = document.createElement("TBODY"), S = document.createElement("TR"), I = document.createElement("TD"), x = document.createElement("A"); Y < B;) {
            if (M = Y, M % 7 == 0 && (S = document.createElement("TR")), F = M - A + 1, E = e.toString() + "-" + NepaliFunctions.Get2DigitNo(t) + "-" + NepaliFunctions.Get2DigitNo(F), C = "", C = e === r && t === a && F === o ? "ndp-selected" : e === s && t === c && F === m ? "ndp-current" : "ndp-date", M < A) I = document.createElement("TD"), S.appendChild(I);
                ...
                if (I = document.createElement("TD"), I.setAttribute("class", C), i.disableAfter && NepaliFunctions.CompareBsDates(NepaliFunctions.ConvertToDateObject(E, "YYYY-MM-DD"), i.disableAfter) || i.disableBefore && NepaliFunctions.CompareBsDates(i.disableBefore, NepaliFunctions.ConvertToDateObject(E, "YYYY-MM-DD"))) x = document.createElement("A"), x.setAttribute("class", "ndp-disabled"), x.setAttribute("href", "javascript:void(0)"), x.setAttribute("title", E), x.innerHTML = u ? F : NepaliFunctions.ConvertToUnicode(F), I.appendChild(x);
                    ...
                    x = document.createElement("A"), x.setAttribute("href", "javascript:void(0)"), x.setAttribute("title", E), x.setAttribute("data-value", w), x.innerHTML = u ? F : NepaliFunctions.ConvertToUnicode(F), x.addEventListener("click", function() { p(this) }), I.appendChild(x)
                }
                S.appendChild(I)
            }
    ...
    function l(e) {
        if ("body" != b().container) { var t = e.getBoundingClientRect(); return { x: t.x, y: t.y } }
        var n = 0,
            r = 0;
        return n += s(e), r += c(e), { x: n, y: r }
    }

    function s(e) { for (var t = 0; e;) t += e.offsetLeft, e = e.offsetParent; return t += document.firstChild.offsetLeft || 0 }
    ...
    function h(e, t) { var n = window.pageYOffset || (document.documentElement || document.body.parentNode || document.body).scrollTop; return window.innerHeight - t.y - e.offsetHeight + n }

    function p(e) {
        var t = e.getAttribute("data-value"),
            n = b(),
            r = NepaliFunctions.ConvertToDateObject(t, n.dateFormat);
        n.ndpEnglishInput && (document.getElementById(n.ndpEnglishInput).value = NepaliFunctions.ConvertDateFormat(NepaliFunctions.BS2AD(r), n.dateFormat)), document.getElementById(E).value = n.unicodeDate ? NepaliFunctions.ConvertToUnicode(t) : t, n.onChange && n.onChange({ bs: t, ad: NepaliFunctions.ConvertDateFormat(NepaliFunctions.BS2AD(r), n.dateFormat), object: r }), a("setSelectedDay")
    }
    ...
    function f(e, t, n) {
        ...
        }), d.addEventListener("change", function() { v(t, n) }), d
    }
    ...
    function y(e, t, n, r) {
        ...
        return d.addEventListener("change", function() { g(e, r) }), d
    }

    function v(e, t) { e = b().ndpYear ? parseInt(document.getElementById("ndp-year-select").value) : e, i(e, parseInt(document.getElementById("ndp-month-select").value), t) }
    ...
    Object.prototype.nepaliDatePicker = function(e) {
        ...
        function u(e) { if (null == e || "object" != typeof e) return e; var t = e.constructor(); for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]); return t }

        function d(e, t) { for (var n = !1; e;) { e.getAttribute("id") == t && (n = !0, e = null), e = e ? e.offsetParent : null } return n }
        ...
        function s(e, t) {
            ...
            if (e.classList.add("ndp-nepali-calendar"), i(e, t), t.ndpTriggerButton || e.addEventListener("focus", D), e.addEventListener("blur", l), e.setAttribute("autocomplete", "off"), e.addEventListener("keydown", N), t.readOnlyInput && e.setAttribute("readonly", "readonly"), t.ndpTriggerButton) {
                ...
                u.setAttribute("id", "ndp-click-trigger"), u.setAttribute("class", a), u.addEventListener("click", function() { h(n) }), u.addEventListener("blur", c), u.innerHTML = o, e.insertAdjacentElement("afterend", u)
            }
        }

        function c() { l() }

        function m() { var e = document.getElementById("ndp-nepali-box"); return e && parseInt(e.style.top) > 0 }

        function h(e) { v || (v = !0, m() ? a("toggleCalendar") : o(e), v = !1) }
        var p = this;
        if ("remove" != e) {
            ...
            window.addEventListener("mouseup", function() { if (m()) { "ndp-click-trigger" == document.activeElement.getAttribute("id") || l() } });
            var v = !1
